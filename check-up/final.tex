...
\begin{frame}{Contenu du stage}
\begin{itemize}
    \item Étude de différents modèles de pricing d'options : CRR, Bachelier, Black-Scholes
    \item Implémentation d'un outil interactif en Python (Streamlit)
    \item Étude des greeks et stratégies de couverture (hedging)
    \item Vulgarisation des concepts dans des articles destinés à des étudiants sans pré-requis en finance
    \item Écriture d'un glossaire et d'une bibliographie au fil du stage
\end{itemize}
\end{frame}
