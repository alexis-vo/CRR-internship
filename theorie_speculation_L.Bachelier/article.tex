...
\begin{table}[h]
    ...
    \hline
    \textbf{Aspect} & \textbf{Modèle de Bachelier} & \textbf{Modèle de Black-Scholes} \\
    \hline
    Évolution du prix & Additive & Multiplicative\\
    \hline
    Comportement des prix & Les prix peuvent devenir négatifs & $S_t > 0$ presque sûrement (les prix restent strictement positifs) \\
    \hline
    Comportement en temps court ou faible volatilité & Donne une bonne approximation & Converge aussi vers Bachelier quand $\sigma \to 0$ ou $t \to 0$ \\
    \hline
    Interprétation économique & Moins réaliste pour des actions ou actifs physiques & Plus réaliste pour les actifs financiers (actions, indices, etc.) \\
    \hline
    \end{tabular}
    }
